    ...
    for i in dataframe["result"]:
        try:
            ...
            if len(yt.streams) > 0:
                ...
                keyboard = [[{"text": "Audio"}]]
                keyboard_res = [[{"text": "144p"}], [{"text": "240p"}], [{"text": "360p"}], [{"text": "480p"}],
                                [{"text": "720p"}], [{"text": "1080p"}], [{"text": "1440p"}], [{"text": "2160p"}]]
            ...
            try:
                if i["message"]["text"] in formats:
                    ...
                    if i["message"]["text"] == 'Audio':
                        ...
                        subprocess.call(
                            ["ffmpeg", "-i", input_video, "-i", input_audio, "-c", "copy", output_media, "-y"])
...
base_url = 'https://api.telegram.org/bot6707947673:AAHnueZy7Ssvv4sUL_PL695xIyOPydp5imo'
offset = 0
